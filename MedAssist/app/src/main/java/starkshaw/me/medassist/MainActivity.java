...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    //@InjectView(R.id.log_out) EditText _logout_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Firebase firebaseRef = new Firebase("https://med-assist.firebaseio.com/");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.log_out:
                //unauth();
                final Firebase firebaseRef = new Firebase("https://med-assist.firebaseio.com/");
                if(loginFlag==true) {
                    firebaseRef.unauth();
                    loginFlag = false;
                    if(!isFinishing()) {
