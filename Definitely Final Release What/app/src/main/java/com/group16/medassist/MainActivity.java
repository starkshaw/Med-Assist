    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.SendMailIcon: {
                ...
                int numberOfContacts = db.getNumberOfContacts();
                db.closeDB();
                if(numberOfContacts == 0) {
                    Toast.makeText(this, "Create a contact first before you can send email", Toast.LENGTH_LONG).show();
                    return;
                } else intent = new Intent(this, SendMailActivity.class);
                break;
            }
